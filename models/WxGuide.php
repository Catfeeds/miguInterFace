...
/**
 * This is the model class for table "{{wx_guide}}".
 *
 * The followings are the available columns in table '{{wx_guide}}':
 * @property integer $id
 ...
 */
class WxGuide extends CActiveRecord
{
    /**
     ...
     * @return WxGuide the static model class
     */
