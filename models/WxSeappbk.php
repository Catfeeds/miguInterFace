...
class WxSeapp extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('addTime, appid, gid, tType', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, creatorName, description, imageUrl, type, size, downloadUrl, addTime, appid, packageName, gid, version, orders, action, param, tType', 'safe', 'on'=>'search'),
		);
	}
