...
/**
 * This is the model class for table "{{mv_admin}}".
 *
 * The followings are the available columns in table '{{mv_admin}}':
 * @property integer $id
 ...
 */
class MvAdmin extends CActiveRecord
{
	/**
	 ...
	 * @return MvAdmin the static model class
	 */
