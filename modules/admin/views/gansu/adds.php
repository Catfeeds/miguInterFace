    ...
    <table width="100%" cellspacing="0" cellpadding="10" class="mtable">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" value="返回列表" class="gray" onclick="window.location.href='<?php echo Yii::app()->createUrl('/admin/gansu/gonggao',array('mid'=>$this->mid,'nid'=>$_GET['nid']))?>'">
            </td>
        </tr>
    </table>
</form>
<script type="text/javascript">
    $(function(){
        ...
        $.getJSON("/admin/gansu/getcity?mid=<?php echo $_GET['mid']?>",{id:shengid},function(data){
