    ...
    <table width="100%" cellspacing="0" cellpadding="10" class="mtable">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" value="返回列表" class="gray" onclick="window.location.href='<?php echo Yii::app()->createUrl('/admin/notice/index',array('mid'=>$this->mid,'nid'=>$_GET['nid']))?>'">
            </td>
        </tr>
    </table>
</form>
<script type="text/javascript">
    function getregin(){
        ...
        $.getJSON("/admin/notice/getcity?mid=<?php echo $_GET['mid']?>",{id:i[0]},function(data){
