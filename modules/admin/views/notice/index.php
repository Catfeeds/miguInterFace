<div class="btn-parent">
    <a href="<?php echo Yii::app()->createUrl('/admin/notice/add',array('mid'=>$this->mid,'nid'=>$_GET['nid']))?>" class="btn">新增公告</a>
</div>
<div class="mt10">
        ...
        if(!empty($list)){
            foreach($list as $l){?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo Yii::app()->createUrl('/admin/notice/add',array('mid'=>$this->mid,'bid'=>$l['id'],'nid'=>$_GET['nid']))?>">编辑</a>
...
<script type="text/javascript">
    $('.del').click(function(){
        ...
        $.post('/admin/notice/del?mid=<?php echo $this->mid?>',{id:v},function(d){
            if(d.code == 200){
