...
<table class="mtable" width="100%" cellspacing="0" cellpadding="10">
    <tr width="900px">
        <?php
        if(count($ui) == 1){
            echo "<td fid='0' id=".$ui[0]['position']." width='250px'><img src=".$ui[0]['bigImg']." width='80%'><a pos=".$ui[0]['position']." href=".'javascript:void(0)'.">点击修改</a></td>";
            ...
            foreach ($ui as $key => $val) {
                echo "<td fid='$key' id=".$val['position']." width='150px'><img src=".$val['bigImg']." width='80%'><a pos=".$val['position']." href=".'javascript:void(0)'.">点击修改</a></td>";
            }
...
<script type="text/javascript">
    ...
    $('.save').click(function(){
        ...
        $.post('/admin/galaxy/add?mid=<?php echo $this->mid?>',G,function(d){
            if(d.code == 200){
                location.reload();
            }else{
                layer.close(load);
