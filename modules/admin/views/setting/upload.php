...
<table class="mtable" width="100%" cellspacing="0" cellpadding="10">
    <tr>
        ...
        <td>
            ...
            <span id="show">
                ...
                <input type="radio" name="tong" onclick="huibo()" id="hui">回看
            </span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="url" id="url" value="<?php echo !empty($ui[$address][$fid]['url'])?$ui[$address][$fid]['url']:''?>" class="form-input">
            ...
            <textarea cols="52" rows="3" readonly id="dianbo" style="display: none">电影：?viewType=1&foldId=384&contentId=3001234826     电视剧：?viewType=1&foldId=385&contentId=3001234826    综艺：?viewType=1&foldId=50245&returnType=back</textarea>
            <input type="text" readonly class="form-input" id="huibo" style="display: none" value="例如：http://wasuott.itv.cmvideo.cn/a?f=29820&recidentifying=bbqne1507">
        </td>
    </tr>
    <tr>
...
<script type="text/javascript">
    ...
    $('#upload_file').uploadify({
        ...
        'fileTypeExts': '*.jpg;*.png;*.jpeg;*.gif',//限制允许上传的图片后缀
    ...
    $('.save').click(function(){
        ...
        if(empty(G.position)){
            layer.alert('系统错误1111',{icon:0});
            return false;
        }

        if(empty(G.key)){
            layer.alert('系统错误22222',{icon:0});
            return false;
        }
        if(empty(G.type)){
            layer.alert('系统错误333333',{icon:0});
            return false;
        }
