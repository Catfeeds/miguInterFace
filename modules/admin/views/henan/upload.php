...
<table class="mtable" width="100%" cellspacing="0" cellpadding="10">
    ...
    <tr>
        ...
        <td><input type="text" name="title" id="title" value="<?php echo !empty($henan[$address][$fid]['title'])?$henan[$address][$fid]['title']:''?>" class="form-input"></td>
    </tr>
    <tr>
        <td align="right">url：</td>
        <td><input type="text" name="url" id="url" value="<?php echo !empty($henan[$address][$fid]['url'])?$henan[$address][$fid]['url']:''?>" class="form-input">
...
<input type="hidden" name="key" value="<?php echo !empty($henan[$address][$fid]['pic'])?$henan[$address][$fid]['pic']:''?>">
<input type="hidden" name="pos" value="<?php echo $address;?>">
<input type="hidden" name="id" value="<?php echo !empty($henan[$address][$fid]['id'])?$henan[$address][$fid]['id']:''?>">
<script type="text/javascript">
    ...
    $('.save').click(function(){
        ...
        $.post('/admin/henan/add?mid=<?php echo $this->mid?>',G,function(d){
            if(d.code == 200){
                location.reload();
            }else{
                layer.close(load);
