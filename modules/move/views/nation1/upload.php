...
<!--    </tr>-->
    ...
    <tr>
        ...
        <td><input type="text" name="param" id="param" value="<?php if($type==99){ echo !empty($ui[$address][$fid]['param'])?$ui[$address][$fid]['param']:''; }else
            { echo !empty($xiaotu[$address][$fid]['param'])?$xiaotu[$address][$fid]['param']:''; }?>" class="form-input" style="float:left"><input type="submit" name="button" id="pbutton" class="seo-gray" value="搜索" style="float:left;display:none"></td>
    </tr>
    <tr>
