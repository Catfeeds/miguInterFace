<div class="mt10" style="margin-top: 20px;">
    <form action="" method="get">
        <div><a href="<?php echo Yii::app()->createUrl('/move/guide/reports',array('mid'=>$this->mid,'pro'=>!empty($_GET['province'])?($_GET['province']):'','nid'=>$_GET['nid']))?>" class="btn" style="display: inline-block;">返回上一级</a></div>
