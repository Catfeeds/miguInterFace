...
class HTML
{
    ...
    public static function tuijian111($ui){
        $html = '
			<style type="text/css">
				#h-1{width:75px;height:150px;background-color:#898989;}
				#h-2{width:150px;height:150px;background-color:#898989;}
				#h-3{width:235px;height:150px;margin-top:10px;background-color:#898989;}
				#h-4,#h-8{width:150px;height:310px;background-color:#898989;}
				#h-7{width:310px;height:150px;background-color:#898989;}
				#h-5,#h-6{background-color:#898989;width:150px;height:150px;}
			</style>
		';
        $html .= '<div class="modules" style="margin-top:20px;">
					<div class="fl mr10">
    ...
    public static function shaoer111($ui){
        $html = '
			<style type="text/css">
				#h-1{width:75px;height:150px;background-color:#898989;}
				#h-2{width:150px;height:150px;background-color:#898989;}
    ...
    public static function henanssss($henan){
       ...
       $html='<style type="text/css">
                ...
                #down{width:895px; height: 120px;}
                #down img{width:134px; height:100px; }
                #images1{margin-left: -17px;}
                #images2{margin-left: -24px;}
                #images3,#images5{margin-left: -25px;}
                #images4,#images6,#images7,#images8{margin-left: -23px;}
            </style>';
       ...
       $html .= ' </div>';
//       $html .= ' <div>
//                    <img src="../../file/images01.png" style="width: 130px;margin-left: -16px;">
//                    <img src="../../file/images02.png" style="width: 130px;margin-left: -24px;"">
//                  </div>';
       $html .= ' </div>
            <div class="fl mr10">
            <div id="h-3" class="ui-a">';
...
//    public static function lunbo($shuliang){
//        if($shuliang == 3){
//            $html="<div>11</div>";
//
//        }
