    ...
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl . "/js/wx/KeywordReply_AddVoice.js"?>"></script>
...
<div class="menus_r">
    ...
    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="javascript:return funsubmit_update();" autocomplete="off">
        ...
        <div class="clas_box" id="div_replay_news" style="margin-top:0px; padding-top:22px; padding-bottom:0px; ">
            ...
            <div class="class_con">
                <label for="">语音的MediaId</label>
                <!--<input type="file" name="voice_link_url" id="voice_link_url" onblur="onblur_voice_link_url()" />-->
                <input type="text" name="voice_media_id" id="voice_media_id" value="<?php echo !empty($automaticreply->media_id)?$automaticreply->media_id:''?>"  onblur="onblur_voice_media_id()" />
                <a href="javascript:Oclick_ShowBox('voice');" class="class_con_alink_01">点击这里“从素材库选择”</a>　
                <span style="color:#F00;" id="span_voice_media_id"></span>
            </div>
    ...
    <div id="dialogBg" style="display:none;">
        <div id="dialog">
            ...
            <div class="menus_r_openwindow" id="div_material_voice" style="display:none;">
                <input type="hidden" name="PageMaterial_voice" id="PageMaterial_voice" value="1" autocomplete="off" />
                ...
                <div class="mid" style="margin-left:0px; margin-top:0px;">
                    ...
                    <script type="text/javascript">setTimeout(function(){AjaxMaterialSearchInfo('voice')},1000);</script>
                </div>
            </div>
