...
<!--            </div>-->
            <div class="class_con">
                <label for="">描述</label>
                <textarea name="attention_description" id="attention_description" maxlength="150" style="width:528px; height:100px;" onKeyPress="return noStrs(event);" onblur="onblur_attention_description()"><?php echo !empty($automaticreply->description)?$automaticreply->description:''?></textarea>
                <span>最多支持150字</span>
