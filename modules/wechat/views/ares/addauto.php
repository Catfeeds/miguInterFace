        ...
        <div class="clas_box" id="div_replay_news" style="margin-top:0px; padding-top:22px; padding-bottom:0px; ">
            <div class="class_con">
                ...
                <input type="text"
                       ...
                       elseif($MsgType =='attention'){echo "关注回复";}
                       elseif($MsgType =='auto'){echo "自动回复";}?>
                " disabled="disabled" />
            </div>
            <!--            <div class="class_con">-->
            <!--                <label for="">关键字</label>-->
            ...
            <div class="class_con">
                <label for="">描述</label>
                <textarea name="auto_description" id="auto_description" maxlength="150" style="width:528px; height:100px;" onKeyPress="return noStrs(event);" onblur="onblur_auto_description()"><?php echo !empty($automaticreply->description)?$automaticreply->description:''?></textarea>
                <span>最多支持150字</span>
