<style type="text/css">
    ...
    .content ul li{float:left;margin-left:5px;padding-bottom: 20px}
            ...
            <div  height="320px" style="float:left;">
                <div   class="ui-s" style="">
                    ...
                    <?php if(!empty($app)){?>
                            ...
                            <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/app/applist',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                        <?php 
                    }else{?>
                        <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/app/applist',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                        <?php
