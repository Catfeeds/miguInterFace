<style type="text/css">
    ...
    .content ul li{float:left;margin-left:5px;padding-bottom: 20px;height: 200px;}
            ...
            <div  height="320px" style="float:left;">
                <div   class="ui-s" style="">
                    ...
                    <?php if(!empty($app)){
                        ...
                        <?php }else{?>
                            <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/app/app',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                        <?php }
                    }else{?>
                        <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/app/app',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                        <?php
                    ...
                    foreach($app as $key=>$value){?>
                        <li>
                            <div>
                                ...
                                <img src="<?php echo $value['imageUrl']?>" alt="" width="140px"/>
...
$('.del').click(function(){
        ...
        $.post('/wechat/app/del?mid=<?php echo $_GET['mid']?>',{id:id},function(d){
            if(d.code == 200){
    ...
    $('.btn').click(function(){
        ...
        //console.log(orders)
        $.post('/wechat/app/update?mid=<?php echo $this->mid?>',{id:ids,order:orders},function(d){
            if(d.code==200){
                location.reload();
            }
        },'json')
