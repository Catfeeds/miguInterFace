            ...
            <div  height="320px" style="float:left;">
                <div   class="ui-s" style="">
                    ...
                    <?php if(!empty($video)){?>
                            ...
                            <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/recommend/addlist',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                        <?php
                    }else{?>
                        <div class="add add1"><a href="<?php echo Yii::app()->createUrl('/wechat/recommend/addlist',array('mid'=>$this->mid,'nid'=>$_GET['nid'],'classify'=>$_REQUEST['classify']))?>"><img src="../../file/3.png"></a></div>
                    <?php
