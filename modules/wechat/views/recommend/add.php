...
<script>
    ...
    $('.fenlei ul li').click(function(){
        ...
        var p = 1;
        var classify = "<?php echo !empty($_REQUEST['classify'])?$_REQUEST['classify']:''?>";
        window.location.href = "/wechat/recommend/add.html?mid=<?php echo $this->mid?>&nid=<?php echo $_GET['nid']?>&classify="+classify+"&cp="+cp+"&page="+p+"&word="+word;
    ...
    $('.classify').click(function(){
        ...
        window.location.href = "/wechat/recommend/add.html?mid=<?php echo $this->mid?>&nid=<?php echo $_GET['nid']?>&word="+word+"&cp="+cp+"&classify="+classify;
    })
