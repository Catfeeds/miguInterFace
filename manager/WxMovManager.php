...
class WxMovManager extends WxMovie{
    public static function getList($data,$cp,$word){
        ...
        $list = $sql_select . $sql_where_cp . $sql_order . $sql_limit;
    ...
    public static function getLists($data,$classify,$cp,$word){
        $res = array();
        if(!empty($cp) && !empty($word) && !empty($classify)){
            //$cp = 642000+$cp;
            $sql_where_cp="where cp=$cp and title like '%$word%' and classify='$classify'";
        }else if(!empty($cp) && empty($word) && !empty($classify)){
            $sql_where_cp="where cp=$cp and classify='$classify'";
        }else if(empty($cp) && !empty($word) && !empty($classify)){
            $sql_where_cp="where title like '%$word%' and classify='$classify'";
        }else if(!empty($cp) && !empty($word) && empty($classify)){
            $sql_where_cp="where cp=$cp and title like '%$word%'";
        }else if(empty($cp) && empty($word) && !empty($classify)){
            $sql_where_cp="where classify='$classify'";
        }else if(empty($cp) && !empty($word) && empty($classify)){
            $sql_where_cp="where title like '%$word%'";
        }else if(!empty($cp) && empty($word) && empty($classify)){
            $sql_where_cp="where cp=$cp";
    ...
    public static function getAlls($cp,$classify,$word,$p){
        $res = array();
        if(!empty($cp) && !empty($word) && !empty($classify)){
            //$cp = 642000+$cp;
            $sql_where_cp="where cp=$cp and title like '%$word%' and classify='$classify'";
